...
public class ModItems {
    ...
    public static final Item IMPILLAGER_SPAWN_EGG = registerItem("impillager_spawn_egg", new SpawnEggItem(ModEntities.IMPILLAGER, 0x9dc783, 0xbfaf5f, new Item.Settings()));
